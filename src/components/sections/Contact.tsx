...
const contactItems = [
  { icon: '✉', label: 'Email', value: 'networkdealltd21@gmail.com', href: 'mailto:networkdealltd21@gmail.com', color: '#00d4ff' },
  {
    ...
    label: 'WhatsApp', value: '+212 665-158540', href: `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Bonjour Network Deal ! Je vous contacte depuis votre site web.')}`, color: '#25D366',
  },
